...
.PHONY: test-unit
test-unit: ginkgo generate fmt vet envtest
	$(GINKGO) -p --nodes 8 --cover -r -randomize-all --randomize-suites ./...

.PHONY: test
test: generate fmt vet envtest test-unit ## Run tests.
...
MOCKGEN_BIN = mockgen
MOCKGEN = $(shell pwd)/bin/$(MOCKGEN_BIN)-$(MOCKGEN_VER)
.PHONY: mockgen
mockgen: ## Download mockgen locally if necessary.
	$(call go-get-tool,$(MOCKGEN),go.uber.org/mock/mockgen@latest)
