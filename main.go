...
import (
	...
	infrastructureclusterxk8siov1beta1 "sigs.k8s.io/cluster-api-provider-azure/api/v1beta1"
...
func init() {
	...
	utilruntime.Must(infrastructureclusterxk8siov1beta1.AddToScheme(scheme))
